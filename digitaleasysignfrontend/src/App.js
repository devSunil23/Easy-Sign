...
const App = () => {
    return (
        <GoogleOAuthProvider clientId={env("GOOGLE_CLIENT_ID")}>
            <Routes>
                {/* Routes outside Header */}
                <Route path="/login" element={<Login />} />
                <Route path="/signup" element={<Signup />} />

                {/* Routes inside Header */}
                <Route path="/" element={<Header />}>
                    ...
                    <Route
                        ...
                        element={<AwaitedDocuments />}
                    />
                    <Route
                        path="documents/preview"
                        element={<PreviewDocuments />}
                    />
                    <Route
                        path="documents/voided"
                        element={<VoidedDocuments />}
                    />
                    <Route
